  ...
  <div class="container pt-4">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card mb-4">
           <div class="card-body">
           	 <form  method="post" action="ProductOrder">
	           	 <div class="form-controll">
	           	 	<% if(!filename.equals("")){ 
				    %>
				    	<img class="img-rounded" width="300" height="236" src="<%=filename%>">
				    	</br>
				    <% } %>
				    <label for="exampleInputPassword1">Product Name</label>
					    <div class="input-group">
						    <input type="text" readonly="readonly" class="form-control" id="title" name="title" placeholder="" value=<%=title%>>
				 ...
				 <div class="form-controll">
				    ...
				    <textarea readonly="readonly" class="md-textarea form-control" rows="8" name="contents"><%=contents%></textarea>
				 </div>	
				 <div class="form-controll">
				    <label for="exampleInputPassword1">Price(SGD)</label>
				    <input type="text" readonly="readonly" class="form-control"  name="price" value=<%=price%>>
				 </div>					 
				 </br>	
				 <div class="form-controll">
				    <label for="exampleInputPassword1">Order quantity</label>
				    <input type="text" value="1" class="form-control" placeholder="" name = "qty" >
				 </div>	
				 <div class="form-controll">
				 ...
				 <div class="form-controll">
				    ...
				    <input type="date" readonly="readonly" class="form-control" id="writedate" placeholder="" name = "writedate" value=<%=writedate%>>
				 </div>					 
				 </br>				 				 			 	
				<button type="submit" class="btn btn-primary" name="button" value="new" >Order</button>
